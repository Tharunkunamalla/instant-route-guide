      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            About <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">instant-route</span>
          </h1>
          ...
          <Card className="shadow-elegant border-border/50 bg-card/80 backdrop-blur">
            <CardContent className="p-8 md:p-12">
              ...
              <div className="space-y-4 text-lg text-muted-foreground">
                <p>
                  instant-route was born from a simple frustration: finding the best route between two points
                ...
                <p>
                  ...
                  instant-route - a tool that anyone can use, anywhere, anytime.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-hero text-black shadow-2xl border-0">
            <CardContent className="p-8 md:p-12 text-center">
              ...
              <div className="text-black/80">
                Contact us at <span className="font-semibold text-blue-500">careers@instant-route.com</span>
              </div>
            </CardContent>
          </Card>
        </motion.div>
